...
const CreateTicket = () => {
  ...
  const onSubmit = (e) => {
    ...
    axios.post('http://localhost:5000/tickets/create', ticket).then((res) => console.log(res.data));
    ...
    <div>
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="form-group">
          ...
          <select className="form-control" value={projectName} onChange={onChangeProjectName}>
        ...
        <div className="form-group">
          ...
          <select className="form-control" value={assignee} onChange={onChangeAssignee}>
            {users.map((user) => (
        ...
        <div className="form-group">
          ...
          <select className="form-control" value={priority} onChange={onChangePriority}>
